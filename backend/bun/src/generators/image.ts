import type { JSONObjectHTMLSuccessRequest, JSONObjectImageSuccessRequest, NodeHTMLToImageBuffer } from "./../types";
...
export const ImageGenerator = async (json: JSONObjectImageSuccessRequest): Promise<[NodeHTMLToImageBuffer, string]> => {
  ...
  const [code] = await HTMLGenerator(json as unknown as JSONObjectHTMLSuccessRequest);
